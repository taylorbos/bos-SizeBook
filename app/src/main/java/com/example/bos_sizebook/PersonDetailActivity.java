...
public class PersonDetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.putExtra(EditPersonActivity.ARG_ITEM_ID_EDIT, mItem.getPosition());
        ...
        fab2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                SaveAndLoad saveandload = new SaveAndLoad();
                mValues = saveandload.loadFromFile(context);
                int position = Integer.parseInt(getIntent().getStringExtra(PersonDetailFragment.ARG_ITEM_ID));
                mValues.remove(position);
                mValues = fixPosition(mValues);
    ...
    public ArrayList<Person> fixPosition(ArrayList<Person> persons){
        int i = 0;
